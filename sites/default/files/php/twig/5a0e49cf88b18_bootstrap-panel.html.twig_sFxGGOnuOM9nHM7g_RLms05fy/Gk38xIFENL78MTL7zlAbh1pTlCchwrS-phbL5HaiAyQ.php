...
($context["description"] ?? null) && ($this->getAttribute(($context["description"] ?? null), "position", array()) == "invisible"))) ? ("sr-only") : ("")));
  ...
  ";
    ...
    {
        return new Twig_Source("", "themes/bootstrap/templates/bootstrap/bootstrap-panel.html.twig", "/var/www/html/car/themes/bootstrap/templates/bootstrap/bootstrap-panel.html.twig");
    }
}
